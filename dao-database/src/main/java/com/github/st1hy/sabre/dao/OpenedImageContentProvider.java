...
public class OpenedImageContentProvider extends ContentProvider {
    ...
    private static final String TABLENAME = OpenedImageDao.TABLENAME;
    private static final String PK = OpenedImageDao.Properties.Id
            .columnName;

    private static final int OPENEDIMAGE_DIR = 0;
    private static final int OPENEDIMAGE_ID = 1;

    private static final UriMatcher sURIMatcher;

    static {
        sURIMatcher = new UriMatcher(UriMatcher.NO_MATCH);
        sURIMatcher.addURI(AUTHORITY, BASE_PATH, OPENEDIMAGE_DIR);
        sURIMatcher.addURI(AUTHORITY, BASE_PATH + "/#", OPENEDIMAGE_ID);
    }
